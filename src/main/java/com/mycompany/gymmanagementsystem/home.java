...
public class home extends javax.swing.JFrame {
    ...
    private void navigateToScreen(javax.swing.JFrame screen) {
        try {
            if (screen != null) {
                screen.setVisible(true);
                this.dispose(); // Use dispose instead of setVisible(false)
            } else {
                throw new NullPointerException("Unable to navigate to screen - screen is null");
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this,
                "Error navigating to screen: " + e.getMessage(),
                "Navigation Error",
    ...
    private void addMemberMouseClicked(java.awt.event.MouseEvent evt) {
        try {
            navigateToScreen(new newMember());
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this,
                "Error navigating to Add Member: " + e.getMessage(),
                "Navigation Error",
                JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void editMemberMouseClicked(java.awt.event.MouseEvent evt) {
        try {
            navigateToScreen(new editMember());
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this,
                "Error navigating to Edit Member: " + e.getMessage(),
                "Navigation Error",
                JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void trainersMouseClicked(java.awt.event.MouseEvent evt) {
        try {
            navigateToScreen(new trainer());
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this,
                "Error navigating to Trainers: " + e.getMessage(),
                "Navigation Error",
                JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void paymentsMouseClicked(java.awt.event.MouseEvent evt) {
        try {
            navigateToScreen(new memberList());
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this,
                "Error navigating to Members List: " + e.getMessage(),
                "Navigation Error",
                JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void payments1MouseClicked(java.awt.event.MouseEvent evt) {
        try {
            navigateToScreen(new payment());
        } catch (Exception e) {
            JOptionPane.showMessageDialog(this,
                "Error navigating to Payments: " + e.getMessage(),
                "Navigation Error",
                JOptionPane.ERROR_MESSAGE);
        }
    }
